    ...
    jQuery(function() {
        ...
        Dragfn.prototype = {
            init: function (obj) {
                ...
                //三个事件
                self.handle.on("mousedown touchstart", function (ev) {
                    self.start(ev, obj);
                ...
                if(self.options.dragChange) {
                    $(obj).on("mousemove touchmove", function (ev) {
                        self.move(ev, obj);
                    });
                    $(obj).on("mouseup touchend", function (ev) {
                        self.end(ev, obj);
                        if(ev.type != "touchend"){
                            return false;
                        }
            ...
            start: function (ev, obj) {
                ...
                self.disX = (oEvent.clientX || oEvent.originalEvent.targetTouches[0].pageX) - obj.offsetLeft;
                self.disY = (oEvent.clientY || oEvent.originalEvent.targetTouches[0].pageY) - obj.offsetTop;
            ...
            move: function (ev, obj) {
                ...
                var l = (oEvent.clientX || oEvent.originalEvent.targetTouches[0].pageX) - self.disX;
                var t = (oEvent.clientY || oEvent.originalEvent.targetTouches[0].pageY) - self.disY;
                //有父级限制
                if (self.box != null) {
               ...
               /* if(self.options.changeWhen=="move") {
                ...
                if(self.options.handle!=null){
                    ...
                    $(obj).find(self.options.handle).unbind("touchmove");
                    //$(obj).find(self.options.handle).unbind("touchend");
                }else{
