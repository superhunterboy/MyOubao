(function(host, name, Event, undefined){
    var gameConfigData = global_game_config_ssc,
        ...
        gameConfigData['jsPath'] = gameConfigData['jsPath'].replace('ssc', 'l115');
...
(function(){
    ...
    var init = function(config){
        ...
        var Games = bomao.Games;
            //游戏实例
            bomao.Games.L115.getInstance({'jsNameSpace': 'bomao.Games.L115.'});
            //游戏玩法切换
            ...
            //消息类
            bomao.Games.L115.Message.getInstance();
            ...
            Games.getCurrentGame().addEvent('afterSwitchGameMethod', function(e, id) {
                var fullname_cn = Games.getCurrentGame().getGameConfig().getInstance().getMethodCnFullNameById(id),
                    method = Games.getCurrentGame().getCurrentGameMethod(),
