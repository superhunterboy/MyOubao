...
(function(host, GameMethod, undefined){
			...
			$.each(data, function(i){
				...
				html.push('<tr class="'+ trcls +'">');
					...
					if(item['balls'][0] != item['balls'][1] || item['balls'][0] != item['balls'][2]){
						xtText = '<span class="color-hl">二不同</span>';
					}
	...
	var html_head = [];
		...
		html_head.push('<ul class="ball-section ball-section-k3-erbutonghao">');
	var numberHash = {
		'0-0':'12', '0-1':'15',  '0-2':'24',  '0-3':'34',  '0-4':'45',
		'1-0':'13', '1-1':'16',  '1-2':'25',  '1-3':'35',  '1-4':'46',
		'2-0':'14', '2-1':'23',  '2-2':'26',  '2-3':'36',  '2-4':'56'
	};
		//每行
	var html_row = [];
		html_row.push('<li>');
