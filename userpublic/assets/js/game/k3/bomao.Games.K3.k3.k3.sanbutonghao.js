...
(function(host, GameMethod, undefined){
	...
	var html_head = [];
		...
		html_head.push('<ul class="ball-section ball-section-k3-sanbutonghao">');
	var numberHash = {
		'0-0':'123', '0-1':'134',  '0-2':'146',  '0-3':'236',  '0-4':'345',
		'1-0':'124', '1-1':'135',  '1-2':'156',  '1-3':'245',  '1-4':'346',
		'2-0':'125', '2-1':'136',  '2-2':'234',  '2-3':'246',  '2-4':'356',
		'3-0':'126', '3-1':'145',  '3-2':'235',  '3-3':'256',  '3-4':'456'
	};
		//每行
	var html_row = [];
		html_row.push('<li>');
		html_row.push('<ul class="ball-content">');
			$.each(['<#=row#>-0','<#=row#>-1','<#=row#>-2','<#=row#>-3','<#=row#>-4'], function(i){
