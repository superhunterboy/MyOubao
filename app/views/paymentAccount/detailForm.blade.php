...
//exit;
?>
{{ Form::model($data, array('method' => 'post', 'method' => 'post', 'files' => true, 'class' => 'form-horizontal')) }}
@if ($isEdit)
...
//    echo $aColumnSettings[$sColumn]['form_type'];
...
<div class="form-group ">
    ...
    <div class="col-sm-6">
        <input name="qrcode[]" type="file" class="form-control" style="padding:5px;">
    </div>
</div>
<div class="form-group">
