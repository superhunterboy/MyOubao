...
<table style="width:100%"><tr>
        <td style="width:840px">
            <table>
                ...
                <tr>
                    <td style="width:80px" class="text-right">方案编号：</td>
                    <td  style="width:180px">
                ...
                <tr>
                    ...
                    <td  style="width:180px">
                        ...
                        foreach ($validStatus as $key => $value) {
                            $validStatus[$key] = __('_manjcbet.' . strtolower($value));
                        }
                        ?>
                    ...
                    <td  style="width:180px">
                        ...
                        foreach ($validPrizeStatus as $key => $value) {
                            $validPrizeStatus[$key] = __('_manjcbet.' . strtolower($value));
                        }
                        ?>
...
//            $('#download_flag').val('download');
            $('#project_search_form').attr('action', '/jc-bets/download');
//            $('#_action').val('/projects/download');
            $('#project_search_form').submit();
        });
        $('#submitForm').click(function (event) {
            $('#project_search_form').attr('action', '/jc-bets');
            $('#project_search_form').submit();
        });
        //时间控件
