        ...
        <td style="width:980px">
            <table>
                <tr>
                    ...
                    <td><input class="form-control" size="16" type="text" name="postscript" value="{{@$aSearchFields['postscript']}}" ></td>
                ...
                <tr>
                    ...
                    <td> 
                        <select  name="deposit_mode" style="width:100%" class="form-control select-sm">@foreach($aDepositMode as $id =>$name) <option value="{{$id}}"@if(@strlen($aSearchFields['deposit_mode'])>0&&@$aSearchFields['deposit_mode']==$id)selected='selected' @endif>{{__('_deposit.'.$name)}}</option> @endforeach</select>
                    </td>
                </tr>
