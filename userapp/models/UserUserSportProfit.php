 ...
 * @author snowan
 */
class UserUserSportProfit extends UserUserProfit {
    protected $table = 'user_profits_sport';
    public static $resourceName = 'UserUserSportProfit';
    static private $selectSum = [
        ...
        'sum(group_buy_commission) as group_buy_commission',
    ];
    ...
    public static $selectTeamSum = [
        ...
        'COALESCE(sum(team_group_buy_commission + group_buy_commission),0) as group_buy_commission'
    ];
    ...
    public static $listColumnMaps = [
        ...
        'group_buy_commission' => 'group_buy_commission_formatted',
    ];
    protected $fillable = [
        'date',
        'user_id',
    ...
    public static $rules = [
        ...
        'group_buy_commission' => 'numeric|min:0',
        'dividend' => 'numeric|min:0',
    ];

    protected function getGroupBuyCommissionFormattedAttribute() {
        return $this->getFormattedNumberForHtml('group_buy_commission');
    }
