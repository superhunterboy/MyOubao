		...
		<div class="container">
			...
			<div class="account-wrapper clearfix" id="J-spo-header">
			    ...
			    <div class="account-body">
			      ...
			      <form id="J-form" class="form0719 form-horizontal account-form" method="POST" action="{{ $sKeyword ? route('signup', ['prize' => $sKeyword]) : route('signup') }}">
			      ...
			      <input type="hidden" name="_random" value="{{ createRandomStr() }}">
			        ...
			        <div class="form-group">
			          ...
			          <div class="col-sm-10 feild-row">
			          		<span class="reg-title"> 注册即有机会领小米Note2</span>
			    ...
			    <input name="phone" type="text" class="form-control f-password2" id="J-password2" tabindex="3" placeholder="请输入11位手机号以便电话您发放奖品">
			        ...
			        <div class="form-group">
			          <label for="J-password2" class="col-sm-2 control-label">确认密码</label>
						<div class="col-sm-10 feild-row">
							<p class="qq-panel">
								<a class="aa" href="http://wpa.qq.com/msgrd?v=3&amp;uin=86431855&amp;site=qq&amp;menu=yes">客服QQ:86431855</a>
								<span class="aa aa-2">活动Q群: 344093179</span>
							</p>
						</div>
			        </div> <!-- /.form-group -->
...
(function($){
	...
	$('.spo-text-1 .dj1').on('click',function () {
		var _a =['<img src="/assets/images/spo/0719-1.jpg"/>','<img src="/assets/images/spo/0719-2.jpg"/>'],
				_index = $(this).index();
