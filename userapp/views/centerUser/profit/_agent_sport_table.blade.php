<table width="100%" class="table">
    ...
    <tbody>
        <tr>
            ...
            <td><span>{{ number_format($oAgentSumPerDay->group_buy_commission,4)}}</span></td>
    ...
    <tbody>
        <tr>
            ...
            <td><span class="{{ $gameProfit < 0 ? 'c-red' : 'c-green' }}">{{ ($gameProfit > 0 ? '+' : '') }}{{ number_format($gameProfit, 4) }}</span></td>
            <td><span>{{ number_format($oSelfProfit->group_buy_commission,4)}}</span></td>
    ...
    @foreach ($datas as $data)
        <tr>
            ...
            <td><span class="{{ $gameProfit < 0 ? 'c-red' : 'c-green' }}">{{ $gameProfit > 0 ? '+' : '' }}{{ number_format($gameProfit, 4) }}</span></td>
            <td><span>{{ number_format($data->group_buy_commission,4) }}</span></td>
