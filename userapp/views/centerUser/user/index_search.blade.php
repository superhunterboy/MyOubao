<div class="area-search">
    <form action="{{ route('users.index') }}" method="get" id="J-form" autocomplete="off">
        ...
        <p class="row">
            ...
            &nbsp;&nbsp;
            注册时间：
            <input type="text" name="sign_date_from" value="{{ Input::get('sign_date_from') }}" class="input w-2" id="J-date-start" />
            至
            <input type="text" name="sign_date_to" value="{{ Input::get('sign_date_to') }}" class="input w-2" id="J-date-end" />
            &nbsp;&nbsp;
            ...
            &nbsp;&nbsp;
            <select name="series_type" id="J-select-series-type">
                <option value="0">所有游戏</option>
                <option value="1" {{ Input::get('series_type')==1 ? 'selected="selected"':'' }}>彩票</option>
                <option value="2" {{ Input::get('series_type')==2 ? 'selected="selected"':'' }}>电子娱乐</option>
            </select>
            &nbsp;&nbsp;
            返点：<input type="text" name="commission_rate" value="{{Input::get('commission_rate')}}" class="input" style="width:40px;">%
            &nbsp;&nbsp;
