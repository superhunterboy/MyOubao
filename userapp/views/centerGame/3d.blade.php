...
.play-select-title .gametypes-menu-housan .content .types-node-zhixuan {height: auto;}
...
.play-select-title .gametypes-menu-erxing .content .sj {left: 33px;}
...
var global_game_config_3d = {{ $sLotteryConfig }};
