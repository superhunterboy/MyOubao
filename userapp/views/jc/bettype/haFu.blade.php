...
<dl class="row row-header">
    ...
    <dd class="col-bet">
        ...
        <div class="line clearfix">
            <span class="cell">胜胜</span>
            <span class="cell">胜平</span>
            <span class="cell">胜负</span>
            <span class="cell">平胜</span>
            <span class="cell">平平</span>
            <span class="cell">平负</span>
            <span class="cell">负胜</span>
            <span class="cell">负平</span>
            <span class="cell cell-last">负负</span>
        </div>
    </dd>
	                    ...
	                    @foreach ($method->codeList as $oOdds)
                                            @if(!$data->is_selling)
                                                <span class="item history-item">
                                                    <b><span @if($oOdds->code==$method->getResult($data)) class="result-item" @endif >{{ $oOdds->name }}</span></b>
                                                </span>
                                            @else
