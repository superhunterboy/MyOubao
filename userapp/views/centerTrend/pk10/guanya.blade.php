        ...
        <table class="chart-table" id="J-chart-table">
            <thead class="thead">
                <tr class="title-text">
                    ...
                    <th colspan="12" class="border-right border-bottom">跨度走势</th>
                    <th colspan="8" class="border-bottom border-bottom">冠亚和</th>
                </tr>
                <tr class="title-number">
                    ...
                    <th class="border-bottom-header td-bg">大</th>
                    <th class="border-bottom-header td-bg">小</th>
                    <th class="border-bottom-header td-bg">单</th>
                    <th class="border-bottom-header border-right td-bg">双</th>
                    <th class="border-bottom-header td-bg">升</th>
                    <th class="border-bottom-header td-bg">平</th>
                    <th class="border-bottom-header border-right td-bg">降</th>
                    <th class="border-bottom-header border-right td-bg">和值</th>
            ...
            <tbody class="tbody tbody-footer-header">
                ...
                <tr class="auxiliary-area title-text">
                    ...
                    <td colspan="12" class="border-right border-bottom">跨度走势</td>
                    <th colspan="8" class="border-bottom">冠亚和</th>
                </tr>
...
@section('end')
    ...
    <script>
        ...
        (function($){
            ...
            CHART = new bomao.GameCharts({currentGameType:'cqssc', currentGameMethod: 'Qianer', expands:{
                getDataUrl:function(){
                ...
                layoutLotteryBall: function(ballsData, styleName) {
                    ...
                    for (var i = 0, current; i < ballsData.length; i++) {
                        ...
                        td2 = document.createElement('td');
                        td2.className = borderStyleText + ' border-bottom ';
                        td2.innerHTML = '<i data-info="' + current.join(',') + '" class="ball-noraml ' + ballStyleText + '">' + (current[0] == 0 ? current[1] : current[0]) + '</i>'
                        htmlData.appendChild(td2);
                    };
            ...
            cqsscQianerRender:function(data, currentNum){
                    ...
                    //期号
                    td = document.createElement('td');
                    td.className = "issue-numbers  border-bottom " + styleName;
                    td.innerHTML = data[0];
                    parentDom.appendChild(td);

                    td = document.createElement('td');
                    td.className = "ball-none border-right border-bottom " + styleName;
                    parentDom.appendChild(td);
                    ...
                    //开奖号码
                    td = document.createElement('td');
                    td.className = styleName + ' border-bottom ';
                    ...
                    */
                    ...
                    //号码分布
                    parentDom.appendChild(me.layoutLotteryBall(data[4], styleName));
                    td = document.createElement('td');
                    td.className = "ball-none border-right border-bottom " + styleName;
                    parentDom.appendChild(td);
                    ...
                    for(i = 0,len = 10; i < len; i++){
                        if(data[5][i][0] == 0){
                            ...
                            td.innerHTML = '<i class="ball-noraml">'+ data[5][i][1] +'</i>';
                            parentDom.appendChild(td);
                        }else{
                            td = document.createElement('td');
                            td.className = "omission  border-bottom " + styleName;
                            td.innerHTML = data[5][i][0];
                            parentDom.appendChild(td);
                        }
                    }
                    ...
                    //大小单双 1 0 3 2
                    var flagHash1 = {
                        '1':'<span class="other-flag other-flag-big">大</span>',
                        '0':'<span class="other-flag other-flag-small">小</span>',
                        '3':'<span class="other-flag other-flag-odd">单</span>',
                        '2':'<span class="other-flag other-flag-even">双</span>'
                    };
                    //大
                    td = document.createElement('td');
                    td.className = styleName;
                    td.innerHTML = data[6] === 1 ? flagHash1[''+data[6]] : '';
                    parentDom.appendChild(td);
                    //小
                    td = document.createElement('td');
                    td.className = styleName;
                    td.innerHTML = data[6] === 0 ? flagHash1[''+data[6]] : '';
                    parentDom.appendChild(td);
                    //单
                    td = document.createElement('td');
                    td.className = styleName;
                    td.innerHTML = data[7] === 3 ? flagHash1[''+data[7]] : '';
                    parentDom.appendChild(td);
                    //双
                    td = document.createElement('td');
                    td.className = styleName + ' border-right';
                    td.innerHTML = data[7] === 2 ? flagHash1[''+data[7]] : '';
                    parentDom.appendChild(td);

                    //升平降 1 2 3
                    var flagHash2 = {
                        '1':'<span class="other-flag other-flag-up">升</span>',
                        '2':'<span class="other-flag other-flag-p">平</span>',
                        '3':'<span class="other-flag other-flag-down">降</span>'
                    };
                    //升
                    td = document.createElement('td');
                    td.className = styleName;
                    td.innerHTML = data[8] === 1 ? flagHash2[''+data[8]] : '';
                    parentDom.appendChild(td);
                    //平
                    td = document.createElement('td');
                    td.className = styleName;
                    td.innerHTML = data[8] === 2 ? flagHash2[''+data[8]] : '';
                    parentDom.appendChild(td);
                    //降
                    td = document.createElement('td');
                    td.className = styleName + ' border-right ';
                    td.innerHTML = data[8] === 3 ? flagHash2[''+data[8]] : '';
                    parentDom.appendChild(td);
                ...
                cqsscQianerRenderStatistics: function(data){
                    ...
                    frame1.push('<td class="ball-none border-bottom"></td>');
                    frame2.push('<td class="ball-none border-bottom"></td>');
                    frame3.push('<td class="ball-none border-bottom"></td>');
                    frame4.push('<td class="ball-none border-bottom"></td>');
                    ...
                    for(i = 0; i < 8; i++){
                        if(i == 3 || i == 6){
                            ...
                            frame1.push('<td class="border-bottom"></td>');
                            frame2.push('<td class="border-bottom"></td>');
                            frame3.push('<td class="border-bottom"></td>');
