        ...
        <table class="chart-table" id="J-chart-table">
            <thead class="thead">
                <tr class="title-text">
                    ...
                    <th rowspan="2" class="border-bottom border-right">三同号</th>
                    <th rowspan="2" class="border-bottom border-right">二同号</th>
...
@section('end')
    ...
    <script>
        ...
        (function($){
            ...
            CHART = new bomao.GameCharts({currentGameType:'cqssc', currentGameMethod: 'Housan', expands:{
                getDataUrl:function(){
                ...
                cqsscHousanRender:function(data, currentNum){
                    ...
                    td.innerHTML = (data[6]).join('');
                    parentDom.appendChild(td);

                    //三同号
                    td = document.createElement('td');
                    td.className = 'border-right ' + styleName;
                    td.innerHTML = data[7][0] == 0 ? '<i class="group-current"></i>' : data[7][0];
                    parentDom.appendChild(td);

                    //二同号
                    td = document.createElement('td');
                    td.className = 'border-right ' + styleName;
                    td.innerHTML = data[8][0] == 0 ? '<i class="group-current"></i>' : data[8][0];
                    parentDom.appendChild(td);

                    //三不同
                    td = document.createElement('td');
                    td.className = 'border-right ' + styleName;
                    td.innerHTML = data[9][0] == 0 ? '<i class="group-current"></i>' : data[9][0];
                    parentDom.appendChild(td);
                ...
                cqsscHousanRenderStatistics: function(data){
                    ...
                    for(i = 0, len = 18; i < len; i++){
                        tdstr = ((i+1)%6 == 0) ? '<td class="ball-none border-right border-bottom"></td><td class="ball-none border-bottom"></td>' : '';
                        tdstr = (i == (len - 1)) ? '<td class="ball-none border-right border-bottom"></td>' : tdstr;
                    ...
                    var jumpnum = 21;
                    for(i = 0; i < 13; i++){
                        jumpnum = i >19 ? jumpnum = 21 : 20;
                        //形态
                        if(i == 0 || i == 6){
                            if(i == 6){
                                frame1.push('<td class="border-bottom border-none"><i class="ball-noraml">'+ data[0][jumpnum + i - 4] +'</i></td>');
                                frame2.push('<td class="border-bottom border-none"><i class="ball-noraml">'+ data[1][jumpnum + i - 4] +'</i></td>');
                                frame3.push('<td class="border-bottom border-none"><i class="ball-noraml">'+ data[2][jumpnum + i - 4] +'</i></td>');
                                frame4.push('<td class="border-bottom border-none"><i class="ball-noraml">'+ data[3][jumpnum + i - 4] +'</i></td>');
                            }else{
                                frame1.push('<td class="border-bottom border-none"></td>');
                                frame2.push('<td class="border-bottom border-none"></td>');
                                frame3.push('<td class="border-bottom border-none"></td>');
                                frame4.push('<td class="border-bottom border-none"></td>');
                            }
                            ...
                            if(i == 7){
                                ...
                                frame1.push('<td class="border-bottom border-right"><i class="ball-noraml">'+ data[0][jumpnum + i - 4] +'</i></td>');
                                frame2.push('<td class="border-bottom border-right"><i class="ball-noraml">'+ data[1][jumpnum + i - 4] +'</i></td>');
                                frame3.push('<td class="border-bottom border-right"><i class="ball-noraml">'+ data[2][jumpnum + i - 4] +'</i></td>');
                                frame4.push('<td class="border-bottom border-right"><i class="ball-noraml">'+ data[3][jumpnum + i - 4] +'</i></td>');  
                            }
